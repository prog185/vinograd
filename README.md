...
1. В открывшейся обработке заполнить следующие поля:
    ...
    1. **Имя файла правил** - скачанный файл **ПравилаОбменаДанными_Справочники.xml**. На вопрос "Загрузить правила обмена данными?" отвечтить положительно. После этого бдет заполнена табличная часть 
